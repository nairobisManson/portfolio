...
<a class="navbar-brand" href="index.html">nairobis manson </a>
...
let footer = $(`
<footer class="footer sticky-bottom"  style="background-color:#03000a;">
  <div class="p-4">
    <div class="container-fluid quote-container">
     
      <p class="tag" >"Empathy is at the heart of design. without understanding what others see, feel and experience, design is a useless task" - Tim Brown</p>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 col-md-12 mb-4 mb-md-0 justify-content-center">
          <img src="assets/images/vortext.gif" class="paralax" alt="hongo" width="300" height="300"> 
          <img src="assets/images/mask.png" class="paralax" alt="hongo" width="300" height="300"> 
...
function parallax(event) {
  document.querySelectorAll(".parallax-wrap span").forEach((shift) => {
    ...
    const y = (window.innerHeight - this.scrollY * position) / 90;
  ...
  $(window).scroll(function () {
    ...
    if ($(window).scrollTop() < $(window).height()) {
      ...
      if (
        ...
        $("#btnScrollToTop").css("background-color", "#bb86fc");
      } else {
        $("#btnScrollToTop").css("background-color", "#bb86fc");
      }
    }
